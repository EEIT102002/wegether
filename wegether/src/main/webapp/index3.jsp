...
#contentRemind>div .dropdown-item {
	width: 300px;
	text-align: left;
	margin: 0;
	position: relative;
...
#contentRemind .panel>.dropdown-item {
	justify-content: space-between;
	min-height: 60px;
}

#contentRemind>div .dropdown-item>div {
	display: flex;
	/* height: 100%; */
}

#contentRemind>div .dropdown-item>div:nth-last-child(2) {
...
#contentRemind>div .dropdown-item>div:nth-last-child(2)>div:nth-child(2)
	{
	height: 30%;
	display: flex;
	justify-content: space-between;
...
#contentRemind>div .dropdown-item>div:nth-last-child(2)>div:nth-child(2) div
	{
	font-size: 14px;
}

#contentRemind>div .dropdown-item>div:nth-last-child(2)>div:nth-child(2)>a div
	{
	width: 50px;
	display: flex;
...
#contentRemind>div .dropdown-item>div:nth-last-child(1) {
	/* background-color: green; */
	display: flex;
	width: 40px;
	justify-content: center;
...
#contentRemind>div .dropdown-item>div:nth-last-child(3) {
	display: flex;
	justify-content: center;
	align-items: center;
	padding-left: 5px;
...
#contentRemind>div .dropdown-item>div:nth-last-child(3)>div {
	width: 50px;
	height: 50px;
	background-color: blue;
	border-radius: 50px;
...
#contentRemind>div .dropdown-item>div:nth-last-child(3)>div>img {
	width: 50px;
	height: 50px;
	border-radius: 50px;
}

#contentRemind>div .dropdown-item button {
	height: 30px;
	flex: 1 1 300px;
...
#contentRemind>div .dropdown-item button:nth-child(1) {
	background-color: #008CBA;
}

#contentRemind>div .dropdown-item button:nth-child(2) {
	background-color: #f44336;
}

#contentRemind .collapse .dropdown-item {
	min-height: 20px;
	background-color: rgba(2, 2, 2, 0.048);
}

#liRing .noticemenu>div:nth-child(1) {
	line-height: 2em;
	padding-left: 1em;
	display: flex;
	align-items: center;
...
#liRing .noticemenu>div:nth-child(3) {
...
#liRing .noticemenu>div:nth-child(3) button {
	flex: 1 1 300px;
	background-color: white; /* Green */
	border: none;
	/*     color: white; */
...
#liRing .noticemenu>div:nth-child(3) button:nth-child(1) {
	border-right: 1px solid rgba(128, 128, 128, 0.329);
}

#liRing .noticemenu>div:nth-child(3) button:nth-child(2) {
	border-left: 1px solid rgba(128, 128, 128, 0.329);
}
...
<body>
			...
			<div class="banner-info">
				<div class="from-group">
					...
					<form id="form_act">
						...
						<div class="AreaCon">
							<label>地區 :</label> <select name="cityselect_name"
								id="CitySelect">
								<option value="">--請選擇--</option>
							</select>
						</div>
						<div class="AreaCon">
							<span class="form-group">活動開始日期 :</span> <br> <input
								type="date" class="form-control" id="start_date"
								name="start_date_name"> <br>
						</div>
						<div class="AreaCon">
							<span class="form-group">活動結束日期 :</span> <br> <input
								type="date" class="form-control" id="end_date"
								name="end_date_name"> <br>
						</div>
						<div class="AreaCon" id="typeArea">
							<span>活動類型 :</span> <br>
							<div id="labelflexCon">
								<label class="labelflex"> <input type="checkbox"
									value="運動" name="type_select_name" class="hidden-input">
									<span class="your style about checkbox"></span>
									<p>運動</p> </input>
								</label> <label class="labelflex"> <input type="checkbox"
									value="休閒" name="type_select_name" class="hidden-input">
									<span class="your style about checkbox"></span>
									<p>休閒</p> </input>
								</label> <label class="labelflex"> <input type="checkbox"
									value="音樂" name="type_select_name" class="hidden-input">
									<span class="your style about checkbox"></span>
									<p>音樂</p> </input>
								</label> <label class="labelflex"> <input type="checkbox"
									value="美食" name="type_select_name" class="hidden-input">
									<span class="your style about checkbox"></span>
									<p>美食</p> </input>
								</label> <label class="labelflex"> <input type="checkbox"
									value="聊天" name="type_select_name" class="hidden-input">
									<span class="your style about checkbox"></span>
									<p>聊天</p> </input>
								</label>
							</div>
						...
						<div class="AreaCon" id="keyword_search">
							<span class="form-group">關鍵字搜尋 :</span> <br> <input
								type="text" placeholder="搜尋-活動名稱" class="form-control"
								id="keyword_search_input" name="keyword_search_input_name">
							<br>
						</div>
						<div id="searchbarButton">
							<input id="select_act_submit" type="submit" value="搜尋"
								class="btn btn-warning form-control"> <input
								type="reset" value="清除" class="btn btn-warning form-control">
						</div>
					</form>

					<form id="form_po">
						<div class="AreaCon">
							<label>地區 :</label> <select name="cityselect_name_po"
								id="CitySelect_po">
								<option value="">--請選擇--</option>
							</select>
						</div>
						<div class="AreaCon">
							<span class="form-group">活動開始日期 :</span> <br> <input
								type="date" class="form-control" id="start_date_po"
								name="start_date_name_po"> <br>
						</div>
						<div class="AreaCon">
							<span class="form-group">活動結束日期 :</span> <br> <input
								type="date" class="form-control" id="end_date_po"
								name="end_date_name_po"> <br>
						</div>
						<div class="AreaCon">
							<span>活動類型 :</span> <br> <input type="checkbox" value="運動"
								name="type_select_name_po">運動</input> <input type="checkbox"
								value="休閒" name="type_select_name_po">休閒</input> <input
								type="checkbox" value="音樂" name="type_select_name_po">音樂</input>
						...
						<input type="hidden" value="1" name="state_po" /> <input
							type="search" name="keyword_search_input_name_po"
							id="keyword_search_input_po" /> <input id="select_po_submit"
							type="submit" value="搜尋" /> <input type="reset" value="清除" />
					</form>
				</div>
			</div>
		</div>
	...
	<div class="about" id="about">
		<div class="container">
			...
			<div class="row  masonry" id="show_act_area"></div>
		</div>
		<script
	...
	<i id="upTop" class="fa fa-chevron-circle-up animated infinite bounce"
		aria-hidden="true"></i>
