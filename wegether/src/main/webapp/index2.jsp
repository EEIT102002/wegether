			...
			<div class="collapse navbar-collapse nav-wil" id="dropdown_munu">
				...
				<ul class="nav navbar-nav">
					...
					<li><a href="#" class="scroll" data-toggle="modal"
						data-target="#ActPageBox"><span data-hover="發起活動">發起活動</span></a></li>
					<li><a href="#" class="scroll" data-toggle="modal"
						data-target="#ActPageBox"><span data-hover="發起心得">發起心得</span></a></li>
					<li id="loginSpan"><a href="#" class="scroll"
						data-toggle="modal" data-target="#ActPageBox"><span
							data-hover="登入">登入</span></a></li>
				...
				<div class="from-group">
					...
					<form id="form_act">
						...
						<div class="AreaCon" id="typeArea">
							...
							<div id="labelflexCon">
								<label class="labelflex"> <input type="checkbox"
									value="運動" name="type_select_name" class="hidden-input"><span
									class="your style about checkbox"></span>
								<p>運動</p>
									</input>
								</label> <label class="labelflex"> <input type="checkbox"
									value="休閒" name="type_select_name" class="hidden-input"><span
									class="your style about checkbox"></span>
								<p>休閒</p>
									</input>
								</label> <label class="labelflex"> <input type="checkbox"
									value="音樂" name="type_select_name" class="hidden-input"><span
									class="your style about checkbox"></span>
								<p>音樂</p>
									</input>
								</label> <label class="labelflex"> <input type="checkbox"
									value="美食" name="type_select_name" class="hidden-input"><span
									class="your style about checkbox"></span>
								<p>美食</p>
									</input>
								</label> <label class="labelflex"> <input type="checkbox"
									value="聊天" name="type_select_name" class="hidden-input"><span
									class="your style about checkbox"></span>
								<p>聊天</p>
									</input>
								</label>
						...
						<div class="AreaCon" id="keyword_search">
							<span class="form-group">關鍵字搜尋 :</span><br> <input
								...
								id="keyword_search_input" name="keyword_search_input_name"><br>
						</div>
					...
					<form id="form_po">
						...
						<div class="AreaCon" id="typeArea_po">
							...
							<div id="labelflexCon">
								<label class="labelflex"> <input type="checkbox"
									value="運動" name="type_select_name_po" class="hidden-input"><span
									class="your style about checkbox"></span>
								<p>運動</p>
									</input>
								</label> <label class="labelflex"> <input type="checkbox"
									value="休閒" name="type_select_name_po" class="hidden-input"><span
									class="your style about checkbox"></span>
								<p>休閒</p>
									</input>
								</label> <label class="labelflex"> <input type="checkbox"
									value="音樂" name="type_select_name_po" class="hidden-input"><span
									class="your style about checkbox"></span>
								<p>音樂</p>
									</input>
								</label> <label class="labelflex"> <input type="checkbox"
									value="美食" name="type_select_name_po" class="hidden-input"><span
									class="your style about checkbox"></span>
								<p>美食</p>
									</input>
								</label> <label class="labelflex"> <input type="checkbox"
									value="聊天" name="type_select_name_po" class="hidden-input"><span
									class="your style about checkbox"></span>
								<p>聊天</p>
									</input>
								</label>
						...
						<div class="AreaCon" id="keyword_search_po">
							<span class="form-group">關鍵字搜尋 :</span><br> <input
								type="search" placeholder="搜尋-活動名稱" class="form-control"
								name="keyword_search_input_name_po" id="keyword_search_input_po" />
						</div>
