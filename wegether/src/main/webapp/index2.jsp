<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
		...
		<head>
			...
			<link href='http://fonts.googleapis.com/css?family=Cabin:400,400italic,500,500italic,600,600italic,700,700italic' rel='stylesheet'
			 type='text/css'>
						...
						<div class="collapse navbar-collapse nav-wil" id="dropdown_munu">
							<nav class="header_nav">
								<ul class="nav navbar-nav">
									...
									<li id="loginSpan">
										<a href="#" class="scroll" data-toggle="modal" data-target="#ActPageBox">
					...
					<div class="banner-info">
						<div class="from-group">
							...
							<form id="form_act">
								...
								<div class="AreaCon">
									<span class="form-group">活動開始日期 :</span>
									<br>
									<input type="date" class="form-control" id="start_date" name="start_date_name">
									<br>
								</div>
								<div class="AreaCon">
									<span class="form-group">活動結束日期 :</span>
									<br>
									<input type="date" class="form-control" id="end_date" name="end_date_name">
									<br>
								</div>
								<div class="AreaCon" id="typeArea">
									...
									<div id="labelflexCon">
										<label class="labelflex">
											<input type="checkbox" value="運動" name="type_select_name" class="hidden-input">
											<span class="your style about checkbox"></span>
											<p>運動</p>
											</input>
										</label>
										<label class="labelflex">
											<input type="checkbox" value="休閒" name="type_select_name" class="hidden-input">
											<span class="your style about checkbox"></span>
											<p>休閒</p>
											</input>
										</label>
										<label class="labelflex">
											<input type="checkbox" value="音樂" name="type_select_name" class="hidden-input">
											<span class="your style about checkbox"></span>
											<p>音樂</p>
											</input>
										</label>
										<label class="labelflex">
											<input type="checkbox" value="美食" name="type_select_name" class="hidden-input">
											<span class="your style about checkbox"></span>
											<p>美食</p>
											</input>
										</label>
										<label class="labelflex">
											<input type="checkbox" value="聊天" name="type_select_name" class="hidden-input">
											<span class="your style about checkbox"></span>
											<p>聊天</p>
											</input>
										</label>
								...
								<div class="AreaCon" id="keyword_search">
									<span class="form-group">關鍵字搜尋 :</span>
									<br>
									<input type="text" placeholder="搜尋-活動名稱" class="form-control" id="keyword_search_input" name="keyword_search_input_name">
									<br>
								</div>
							...
							<form id="form_po">
								...
								<div class="AreaCon">
									<span class="form-group">活動開始日期 :</span>
									<br>
									<input type="date" class="form-control" id="start_date_po" name="start_date_name_po">
									<br>
								</div>
								<div class="AreaCon">
									<span class="form-group">活動結束日期 :</span>
									<br>
									<input type="date" class="form-control" id="end_date_po" name="end_date_name_po">
									<br>
								</div>
								<div class="AreaCon">
									<span>活動類型 :</span>
